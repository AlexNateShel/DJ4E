...
APP_NAME = 'My First Django Site'

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-yepb9j8)w3otn__kq45h21#gfz63micblouex2!d59)4ye8a6r'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'AlexNateShel$ads',
        'USER': 'AlexNateShel',
        'PASSWORD': 'kugFw2#gL%6be%7bb95s',
        'HOST': 'AlexNateShel.mysql.pythonanywhere-services.com',
         'OPTIONS': {
